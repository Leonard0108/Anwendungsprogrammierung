...
=== Kassensubsystem
image::./models/design/Kassensubsystem/sequenzdiagram_Kassensubsystem.svg[Sequenz diagram, 100%, 100%, pdfwidth=100%, title= "Sequenzdiagramm des Kassensubsystem für die MakeOrderController-Funktionen", align=center]

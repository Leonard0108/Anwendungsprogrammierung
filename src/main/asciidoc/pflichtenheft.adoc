...
|2.0     | Meilenstein | 30.07.2024          | Lukas Diettrich, Yannick Harnisch, Simon Liepe, Jannik Schwaß, Tobias Knoll  | Abgabe
|===
...
|Auslöser                   |Die Person will den Mitarbeiter persönlich nach einer Reservierung fragen. Der Mitarbeiter muss dann auf "Plätze Reservieren"-Button klicken.
...
|grundlegende Schritte     a|
1. Person fragt den Mitarbeiter (vor Ort oder telefonisch) nach einer Reservierung. Der Mitarbeiter klickt auf den "Plätze Reservieren"-Button. Das System öffnet ein Untermenü, welches ein Formular für eine neue Reservierung bereitstellt.
...
|Rollen                     |Mitarbeiter, Person
|Auslöser                   |Die Person will das der Mitarbeiter persönlich eine getätigte Reservierung storniert. Der Mitarbeiter muss dann auf "Stornieren"-Button klicken.
...
|grundlegende Schritte     a|
1. Person gibt den Auftrag an den Mitarbeiter (vor Ort oder telefonisch) eine Reservierung zu stornieren. Der Mitarbeiter klickt auf den "Stornieren"-Button. Das System öffnet ein Untermenü, in welchem der Mitarbeiter eine Reservierung suchen kann.
...
|Voraussetzungen           a|Der Mitarbeiter muss im System die Rolle des autorisierten Mitarbeiters besitzen (durch vorheriges entsprechendes Login, wenn aktuell unangemeldeter Nutzer).
|grundlegende Schritte     a|
1. Autorisierter Mitarbeiter drückt auf den "Filme-Verleih"-Button und anschließend auf einen bestimmten Film. Das System öffnet eine Unteransicht. Dabei wird für den Film die Gesamtauslastung der Kinosäle aller Vorführungen angezeigt.
...
|Beschreibung               |Der Boss ordnet eines Films oder einem Snack einen Preis zu.
|Rollen                     |Boss
|Auslöser                   |Boss will Film-Ticket-Preise oder Snack-Preise festlegen oder bearbeiten.
...
1. Optional: Der Boss sucht nach bereits vorhandenen Film- oder Snack-Preisen.
2. Der Boss wählt einen Film oder einen Snack aus.
2. Der Boss gibt den neuen Preis ein.

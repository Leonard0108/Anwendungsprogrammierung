...
public class UserService {
	...
	public void createUser(RegistrationForm form) {
		...
		userRepository.save(new UserEntry(userAccount,form.getName(), form.getStreetName(), form.getStreetNumber(), form.getCity(), form.getPostalCode(), form.getState(), form.getCountry()));
	}




	public UserEntry createUser(UserAccount userAccount, String name, String streetName, String streetNumber, String city, String postalCode, String state, String country) {
		return userRepository.save(new UserEntry(userAccount, name,  streetName, streetNumber, city, postalCode, state, country));
	}
